  ...
  return (
    <div className='Information'>
      ...
      <section className='info_main'>
        ...
        <div className="field field--required field--half field--show-floating-label" data-address-field="first_name"> 
                <div className="field__input-wrapper">
                  <label className={`field__label field__label--visible a ${focus && 'focus'}`} for="checkout_shipping_address_first_name">Email</label>
                  <input onFocus={() => setFocus(true)} placeholder={!focus && 'Email'} autocomplete="shipping given-name" autocorrect="off" data-backup="first_name" className={`field__inputa ${focus && 'focus'}`} aria-required="true" size="30" type="text"  name="checkout[shipping_address][first_name]" id="checkout_shipping_address_first_name" />
                </div>
              </div>
          ...
          <section className='ship_address'>
            

            <header>Shipping address</header>
            <div className='field__input-wrapper field__input-wrapper--select'>
              <label className='field__label field__label--visible' for="checkout_shipping_address_country">Country/Region</label>
              <select size="1" autocomplete="shipping country" data-backup="country" className="field__input field__input--select" aria-required="true" name="checkout[shipping_address][country]" id="checkout_shipping_address_country" placeholder="Country/region"><option data-code="US" value="United States">United States</option>
                ...
                <option data-code="NG" selected="selected" value="Nigeria">Nigeria</option>
            ...
            <div className='info_f_con'>
              <div className="field field--required field--half field--show-floating-label" data-address-field="first_name"> 
                <div className="field__input-wrapper">
                  <label className={`field__label field__label--visible a ${focusa && 'focus'}`} for="checkout_shipping_address_first_name">First name</label>
                  <input onFocus={() => setFocusa(true)} placeholder={!focusa && 'First name'} autocomplete="shipping given-name" autocorrect="off" data-backup="first_name" className={`field__inputa ${focusa && 'focus'}`} aria-required="true" size="30" type="text"  name="checkout[shipping_address][first_name]" id="checkout_shipping_address_first_name" />
                </div>
              </div>
              <div className="field field--required field--half field--show-floating-label" data-address-field="first_name"> 
                <div className="field__input-wrapper">
                  <label className={`field__label field__label--visible a ${focusb && 'focus'}`} for="checkout_shipping_address_first_name">Last name</label>
                  <input onFocus={() => setFocusb(true)} placeholder={!focusb && 'Last Name'} autocomplete="shipping given-name" autocorrect="off" data-backup="first_name" className={`field__inputa ${focusb && 'focus'}`} aria-required="true" size="30" type="text"  name="checkout[shipping_address][first_name]" id="checkout_shipping_address_first_name" />
                </div>
              </div>
            </div>
            ...
            <div className="field field--required field--half field--show-floating-label" data-address-field="first_name"> 
                <div className="field__input-wrapper">
                  <label className={`field__label field__label--visible a ${focusc && 'focus'}`} for="checkout_shipping_address_first_name">Address</label>
                  <input onFocus={() => setFocusc(true)} placeholder={!focusc && 'Address'} autocomplete="shipping given-name" autocorrect="off" data-backup="first_name" className={`field__inputa ${focusc && 'focus'}`} aria-required="true" size="30" type="text"  name="checkout[shipping_address][first_name]" id="checkout_shipping_address_first_name" />
                </div>
              </div>

            <div className="field field--required field--half field--show-floating-label" data-address-field="first_name"> 
                <div className="field__input-wrapper">
                  <label className={`field__label field__label--visible a ${focusd && 'focus'}`} for="checkout_shipping_address_first_name">Apartment, suite, etc. (optional)</label>
                  <input onFocus={() => setFocusd(true)} placeholder={!focusd && 'Apartment, suite, etc. (optional)'} autocomplete="shipping given-name" autocorrect="off" data-backup="first_name" className={`field__inputa ${focusd && 'focus'}`} aria-required="true" size="30" type="text"  name="checkout[shipping_address][first_name]" id="checkout_shipping_address_first_name" />
                </div>
              </div>

              <div className='info_f_con a'>
                <div className="field field--required field--half field--show-floating-label" data-address-field="first_name"> 
                  <div className="field__input-wrapper">
                    <label className={`field__label field__label--visible a ${focuse && 'focus'}`} for="checkout_shipping_address_first_name">City</label>
                    <input onFocus={() => setFocuse(true)} placeholder={!focuse && 'City'} autocomplete="shipping given-name" autocorrect="off" data-backup="first_name" className={`field__inputa ${focuse && 'focus'}`} aria-required="true" size="30" type="text"  name="checkout[shipping_address][first_name]" id="checkout_shipping_address_first_name" />
                  </div>
                </div>

                <div className="field field--required field--half field--show-floating-label" data-address-field="first_name"> 
                  <div className="field__input-wrapper">
                    <label className={`field__label field__label--visible a ${focusg && 'focus'}`} for="checkout_shipping_address_first_name">state</label>
                    <input onFocus={() => setFocusg(true)} placeholder={!focusg && 'state'} autocomplete="shipping given-name" autocorrect="off" data-backup="first_name" className={`field__inputa ${focusg && 'focus'}`} aria-required="true" size="30" type="text"  name="checkout[shipping_address][first_name]" id="checkout_shipping_address_first_name" />
                  </div>
                </div>

                <div className="field field--required field--half field--show-floating-label" data-address-field="first_name"> 
                  <div className="field__input-wrapper">
                    <label className={`field__label field__label--visible a ${focusf && 'focus'}`} for="checkout_shipping_address_first_name">Postal code</label>
                    <input onFocus={() => setFocusf(true)} placeholder={!focusf && 'Postal code'} autocomplete="shipping given-name" autocorrect="off" data-backup="first_name" className={`field__inputa ${focusf && 'focus'}`} aria-required="true" size="30" type="text"  name="checkout[shipping_address][first_name]" id="checkout_shipping_address_first_name" />
                  </div>
                </div>
                ...
                <div className="field field--required field--half field--show-floating-label" data-address-field="first_name"> 
                  <div className="field__input-wrapper">
                    <label className={`field__label field__label--visible a ${focush && 'focus'}`} for="checkout_shipping_address_first_name">Phone</label>
                    <input onFocus={() => setFocush(true)} placeholder={!focush && 'Phone'} autocomplete="shipping given-name" autocorrect="off" data-backup="first_name" className={`field__inputa ${focush && 'focus'}`} aria-required="true" size="30" type="text"  name="checkout[shipping_address][first_name]" id="checkout_shipping_address_first_name" />
                  </div>
                </div>
          </section>
          <div className='ll'>
            <Link  to='/checkouts/payment'><button className='cta b'>Continue to payment</button></Link>
