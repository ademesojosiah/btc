    ...
    <div className="single_product_screen">
        ...
        <div className='single_product_screen_upper'>
          ...
          <div className="single_product_screen_section_two">
            <img className='single_product_small_image' src="https://cdn.shopify.com/s/files/1/0548/1257/3883/products/kd6se2_grande.png?v=1656671940"  />
            <img className='single_product_small_image' src="https://cdn.shopify.com/s/files/1/0548/1257/3883/products/kd6se_grande.png?v=1656671940"  />
          </div>
